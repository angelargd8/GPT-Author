...
### Requirements Specification (For Complex/Ambiguous tareas)

**When to use:**
- tarea is high-level or vague ("improve the lecture", "analyze the data")
- Multiple valid interpretations exist
- Significant effort required (>1 hour or >3 files)

**When to skip:**
- tarea is clear and specific ("fix typo in line 42")
- Simple single-file edit
- User has already provided detailed requirements

**Protocol:**
1. Use preguntas directas al usuario to clarify ambiguities (max 3-5 questions)
...
The Orchestrator checks the dependency graph before routing any agent. If a phase's inputs are satisfied, it can activate — regardless of whether earlier phases are "complete."
...
The Orchestrator routes agents through the dependency graph. The user says:
...
All skills in the reference below work without pipeline context when invoked directly. They route their agent(s) and return results.
