...
**This is conversational.** Ask questions directly in your text responses, one or two at a time. Wait for the user to respond before continuing. Do NOT use preguntas directas al usuario.

**Agents:** Direct conversation (no role-profile routing)
...
6. Route librarian-critic to check coverage, gaps, recency, scope
7. If gaps found, reroute Librarian for targeted search (max 1 round)
...
6. Route explorer-critic to critique each proposed dataset using the **5-point assessment:**
...
**Agents:** Direct generation (no role-profile routing)
