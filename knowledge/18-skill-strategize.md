...
Design an identification strategy, pre-analysis plan, or formal theory section by routing the appropriate creator (**Strategist** or **Theorist**) and its paired critic.
...
4. Route strategist-critic to review through 4 phases:
...
Route Strategist in PAP mode to produce all standard sections:
...
After PAP creation, optionally route the strategist-critic to review:
...
4. Route **theorist-critic** to review through 4 sequential phases:
